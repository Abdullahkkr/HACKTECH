...
import { Add_inventory } from "./Services-API/api";
...
export default function Inventory() {
  ...
  const InventoryAdd = (e) =>{
    Add_inventory(Unit_ID, Brand, Features, Product_Name, Colour, Description, Images,Cost_Price,Selling_Price,Admin_ID,Category).then((response) =>{

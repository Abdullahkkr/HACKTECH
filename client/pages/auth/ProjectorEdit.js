...
import { ProjectorEdit_inventory } from "./Services-API/api";
...
ProjectorEdit_inventory(Unit_ID, Brand, Features, Product_Name, Colour, Description, Images,Cost_Price,Selling_Price,Admin_ID,Category,Bulb, Projection_Distance, Image_size).then((response) =>{
    ...
    <div className="flex content-center items-center h-full">
        ...
        <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-bg rounded-lg bg-blueGray-850 border-0">
            ...
            <form>
                ...
                <input
                    Projection_Distance="email"
                    className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                    placeholder="Projection Distance"
                    value={Projection_Distance}
                    onChange={(e) => {setProjection_Distance(e.target.value);}}
                />
                </div>
                <div className="relative w-full mb-3">
                <label
                ...
                <input
                    ...
                    value={Image_size}
                    onChange={(e) => {setImage_size(e.target.value);}}
                />
                </div>

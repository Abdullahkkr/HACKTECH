...
import { Mobile_inventory } from "../../Services-API/api";
...
//   {"Unit_ID":req.body.Unit_ID, "RAM":req.body.ram, "Memory":req.body.Memory}
  ...
  const InventoryAdd = (e) =>{
    Mobile_inventory(Unit_ID, Brand, Features, Product_Name, Colour, Description, Images,Cost_Price,Selling_Price,Admin_ID,Category,ram,Memory).then((response) =>{
